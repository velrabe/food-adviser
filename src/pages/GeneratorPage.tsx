...
export function GeneratorPage() {
  ...
  return (
    <div className="page generator-page">
      <h1>Генератор</h1>
      <p className="muted">
        Случайный подбор продуктов по категориям (белок + углеводы + до двух «добавок» на приём). Частота
        появления задаётся полем <strong>«Вес в подборе»</strong> у каждого продукта (относительные веса, не
        проценты по списку). Несколько прогонов — лучшие по очкам варианты на день.
      </p>
