...
export function GeneratorPage() {
  ...
  return (
    <div className="page generator-page">
      <h1>Генератор</h1>
      <p className="muted">
        Подбор по категориям: белок (иногда два разных ~5% случаев), углеводы, добавки (овощи и др.).{' '}
        <strong>Частота 1–100</strong> — относительные доли внутри своей категории (у углеводов 70/50/30 ≈ так
        и делят шанс между собой). Для завтрака/обеда можно задать отдельные колонки (например яйца только на
        завтрак = высокое значение в «З» и пусто в остальных — тогда на завтрак подставится переопределение).
        Несколько прогонов — лучшие варианты по очкам.
      </p>
